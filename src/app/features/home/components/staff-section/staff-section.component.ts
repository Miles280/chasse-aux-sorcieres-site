...
export class StaffSectionComponent {
  membres = [
    ...
    { nom: 'MrGrab', role: 'Animateur', bg: 'bg-pink-800', image: '' },
    { nom: 'Zou :)', role: 'Animateur', bg: 'bg-pink-800', image: '' },
    { nom: 'MOUSTIK', role: 'Animateur', bg: 'bg-pink-800', image: '' },
    { nom: 'Xeoooo_', role: 'Analyste', bg: 'bg-green-800', image: '' },
    {
      nom: 'LouDorée',
      role: 'Graphiste',
      bg: 'bg-orange-800',
